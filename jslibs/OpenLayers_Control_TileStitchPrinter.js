...
OpenLayers.Control.TileStitchPrinter = OpenLayers.Class(OpenLayers.Control, {
    ...
    print: function () {
        ...
        if (! this.printUrl) return alert("Error: printUrl must be set in the constructor.");
        ...
        OpenLayers.Request.POST(
          { url:this.printUrl,
            data:OpenLayers.Util.getParameterString({ width:size.w, height:size.h, tiles:tiles_json, image:request_image }),
